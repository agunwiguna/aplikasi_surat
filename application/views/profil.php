    ...
    <thead>
      <tr>
        <td colspan="3" style="padding-left:0px;">
          <form class="navbar-form" action="<?php echo site_url('profil/search_keyword');?>" method = "post" role="search" style="padding-left:0px;">
            <div class="input-group add-on">
              <input class="form-control" placeholder="Pencarian username" name="keyword" type="text" autocomplete="off" size="55" required>
        ...
        <td colspan="6" align="right" style="padding-right:0px;">
          <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal" > <span class="glyphicon glyphicon-plus" aria-hidden="true" ></span> Tambah Data</button>
        </td>
      </tr>
      ...
      if(count($user)>0)
      {
        foreach($user as $key){ 
          ...
          <tr style="background-color:#dfe1e2; color:black;">
            ...
            <td style="text-align: center;"><?php echo $key->level ?></td>
            <td style="text-align: center;">
             <a href="<?php echo base_url(); ?>profil/update/<?php echo $key->id ?>" class="btn btn-info btn-warning btn-xs">
              <span class="glyphicon glyphicon-pencil"></span> 
            </a>
          </td>
          <td style="text-align: center;">
            <a href="<?php echo base_url(); ?>profil/delete/<?php echo $key->id ?>" class="btn btn-info btn-danger btn-xs">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="alert alert-warning" id="exampleModalLabel"><h3 align="center">Data Pengguna</h3></div>

        </div>
        <div class="modal-body">
          <div class="form-group">
            <form action="<?php echo base_url(); ?>profil/action_add" method="post">
            ...
            <div class="form-group">
              ...
              <div class="form-check">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" name="active" value="0" checked>
                  Nonactive
                </label>
              </div>
              <div class="form-check">
