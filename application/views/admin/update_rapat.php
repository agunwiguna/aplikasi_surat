 ...
 <div class="box">
  ...
  <div class="box-body">
    <?php foreach ($content->result() as $key): ?>
      <form action="<?php echo base_url(); ?>notulensi_rapat/action_update/<?php echo $key->id ?>" method="post">
        <input type="hidden" name="id" value="<?php echo $key->id ?>">
        <div class="box-body">
          <div class="form-group">
            <label for="exampleInputEmail1">Tanggal</label>
            <input type="date" class="form-control" name="waktu" autocomplete="off"  value="<?php echo $key->waktu ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Tempat</label>
            <input type="text" class="form-control" name="tempat" autocomplete="off" value="<?php echo $key->tempat ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Pimpinan</label>
            <input type="text" class="form-control" name="pimpinan" autocomplete="off" value="<?php echo $key->pimpinan ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Agenda</label>
            <input type="text" class="form-control" name="agenda" autocomplete="off" value="<?php echo $key->agenda ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Kehadiran</label>
            <input type="text" class="form-control" name="kehadiran" autocomplete="off" value="<?php echo $key->kehadiran ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Ringkasan</label>
            <input type="text" class="form-control" name="ringkasan" autocomplete="off" value="<?php echo $key->ringkasan ?>">
          </div>
          <div class="form-group">
        ...
        <div class="box-footer">
          ...
          <a href="<?php echo base_url(); ?>admin/notulensi_rapat" class="btn btn-danger" style="width: 70px;">Kembali</a>
        </div>
        <!-- Modal -->
