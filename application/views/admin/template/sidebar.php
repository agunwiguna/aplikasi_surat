      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo site_url('surat_masuk') ?>"><i class="fa fa-envelope-o"></i> Surat Masuk</a></li>
            <li class="active"><a href="<?php echo site_url('surat_keluar') ?>"><i class="fa fa-envelope-open-o"></i> Surat Keluar</a></li>
          </ul>
        </li>
        <li><a href="<?php echo site_url('notulensi_rapat') ?>"><i class="fa fa-address-book-o"></i> <span>Notulensi Rapat</span></a></li>
        <li><a href="<?php echo site_url('profil') ?>"><i class="fa fa-cog"></i> <span>Data Master</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
