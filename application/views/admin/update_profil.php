 ...
 <div class="box">
  ...
  <div class="box-body">
    <?php foreach ($content->result() as $key): ?>
      <form action="<?php echo base_url(); ?>profil/action_update/<?php echo $key->id ?>" method="post">
        <input type="hidden" name="id" value="<?php echo $key->id ?>">
        <div class="box-body">
          <div class="form-group">
            <label for="exampleInputEmail1">Username</label>
            <input type="text" class="form-control" name="username" autocomplete="off"  value="<?php echo $key->username ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Password</label>
            <input type="password" class="form-control" name="password" autocomplete="off" value="<?php echo $key->password ?>">
          </div>
          <div class="form-group">
            <label for="exampleSelect1">Level</label>
            <select class="form-control" name="level" value="<?php echo $key->level ?>">
              <option>Admin</option>
              <option>User</option>
            </select>
          </div>
